...
CHECKPOINT_PATH = "/checkpoints_Base/checkpoint.weights.h5"  # o .h5 completo
TARGET_SIZE = (300, 300)
...
def cargar_modelo():
    ...
    if os.path.exists(TEST_DIR):
        ...
        if class_names:
            ...
            # Si el modelo fue guardado con class_names en atributos, podríamos extraerlos
            # pero por simplicidad usamos índices
    else:
...
class App:
    def __init__(self, root):
        self.root = root
        self.root.title("Clasificador de Videojuegos - CNN")
